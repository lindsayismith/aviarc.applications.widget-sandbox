...
* </p>
* <p>
* <strong>NOTE: As of 2.5.0, the constructor's ID argument is optional.</strong>
...
* @class Calendar
* @constructor
* @param {String} id optional The id of the table element that will represent the Calendar widget. As of 2.5.0, this argument is optional.
...
Calendar.prototype = {
	...
	*/
	 ...
	 *
	 * As of 2.5.0, Calendar supports a simpler constructor 
	 * signature. This method reconciles arguments
	 * received in the pre 2.5.0 and 2.5.0 formats.
	 * 
	 * @protected
	 * @method _parseArgs
	...
	_parseArgs : function(args) {
		/*
		   ...
		   Pre 2.5.0 Constructor signatures
	...
	*/
	init : function(id, container, config) {
		// Normalize 2.5.0, pre 2.5.0 args
	...
	*/
	getSelectedDates : function(format) {
		var returnDates = [],
		...
		for (var d=0;d<selected.length;++d) {
			...
			if (format) {
				function prefixZeros(num) {
					if (num < 10) {
						num = "0" + num;
					}
					return num;
				}
				date = prefixZeros(date.getDate()) + "/" + prefixZeros(date.getMonth() + 1) + "/" + date.getFullYear();
			}
	...
	*/
	hide : function() {
		if (this.beforeHideEvent.fire()) {
            ...
            // Thomas Kear <thomas.kear@coretech.co.nz> 2009-11-03.  Breaks disabling pop-up calendar
			//this.oDomContainer.nextSibling.style.display = "none";
			this.hideEvent.fire();
		}
	},
	...
	*/
	show : function() {
		if (this.beforeShowEvent.fire()) {
			...
			this.oDomContainer.nextSibling.style.display = "block";
			this.showEvent.fire();
		}
	},
	...
	* @deprecated As of 2.5.0, environment information is available in YAHOO.env.ua
	* @see YAHOO.env.ua
	* @property browser
	* @type String
	*/
...
* @class CalendarGroup
* @constructor
* @param {String} id optional The id of the table element that will represent the CalendarGroup widget. As of 2.5.0, this argument is optional.
...
YAHOO.widget.CalendarNavigator.prototype = {
	...
	render: function() {
		...
		if (!this.__rendered) {
// Core Technology Update: MG - Ensure mask is created before nav so that it appears 
// before the nav in the dom. this way the nav can appear above the mask as needed        
			this.createMask();
			this.createNav();
			this.applyListeners();
