...
(function () {
    ...
    Toronto.widget.core.v2_5_0.SelectList = function () {
        this.onSelectedChanged = new Toronto.client.Event("SelectList onSelectedChanged");
        this.onUserSelected = new Toronto.client.Event("SelectList onUserSelected");
    ...
    YAHOO.lang.extend(Toronto.widget.core.v2_5_0.SelectList, Toronto.framework.DefaultWidgetImpl, {

        startup: function (widgetContext) {
            Toronto.widget.core.v2_5_0.SelectList.superclass.startup.apply(this, arguments);
        ...
        bind: function (dataContext) {
            Toronto.widget.core.v2_5_0.SelectList.superclass.bind.apply(this, arguments);
    ...
    YAHOO.lang.augmentProto(Toronto.widget.core.v2_5_0.SelectList, Toronto.util.CssUtils);
