...
public class WidgetNamespaceExamplesDataBrokerFactoryImpl implements DataBrokerFactory {
    ...
    public DataBrokerCreationRecord createDataBroker(ResourceDirectory resourceDir, ClassLoader commandClassLoader) {
        ...
        // is not implemented
        WidgetNamespaceExamplesDataBrokerImpl broker = new WidgetNamespaceExamplesDataBrokerImpl();
