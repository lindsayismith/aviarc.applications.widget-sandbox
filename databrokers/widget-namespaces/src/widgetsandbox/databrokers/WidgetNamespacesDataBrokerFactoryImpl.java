...
public class WidgetNamespacesDataBrokerFactoryImpl implements DataBrokerFactory {
    ...
    public DataBrokerCreationRecord createDataBroker(ResourceDirectory resourceDir, ClassLoader commandClassLoader) {
        ...
        // is not implemented
        WidgetNamespacesDataBrokerImpl broker = new WidgetNamespacesDataBrokerImpl();
